...
<section className="mx-auto max-w-6xl px-6 pb-4">
  <div className="rounded-3xl border border-slate-200 bg-white p-6 text-center">
    ...
    <div className="mt-5 flex items-center justify-center gap-4">
      {/* LinkedIn */}
      <a
        href="https://www.linkedin.com/company/fdl-parcel-network"
        target="_blank"
      ...
      {/* TikTok */}
      <a
        href="https://www.tiktok.com/@fdl.parcel.network"
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-900 transition-transform duration-200 hover:scale-[1.06]"
        aria-label="TikTok"
      ...
      {/* Facebook */}
      <a
        href="https://www.facebook.com/driverjobshub"
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-900 transition-transform duration-200 hover:scale-[1.06]"
        aria-label="Facebook"
      ...
      {/* Instagram */}
      <a
        href="https://www.instagram.com/driver_jobs_hub/"
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-900 transition-transform duration-200 hover:scale-[1.06]"
