...
const features = [
  {
    title: "Driver Compliance & Onboarding",
    image: "/features/onboarding.jpg",
    alt: "Driver compliance and onboarding",
    text:
  ...
  {
    title: "Active Driver Pool",
    image: "/features/pipeline.jpg",
    alt: "Active driver pool",
    text:
  ...
  },
  {
    ...
    alt: "On-site operational support",
    text:
      ...
      <section className="mx-auto max-w-4xl px-6">
        <div className="space-y-4">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="flex flex-col gap-5 rounded-3xl border border-slate-200 bg-white p-5 transition-transform duration-200 hover:scale-[1.02] md:flex-row md:items-center md:p-6"
            >
      ...
      <section className="mx-auto max-w-6xl px-6 pb-4">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 text-center">
          ...
          <div className="mt-5 flex items-center justify-center gap-4">
            <a href="#" className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-900 transition-transform duration-200 hover:scale-[1.06]" aria-label="LinkedIn">
            ...
            <a href="#" className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-900 transition-transform duration-200 hover:scale-[1.06]" aria-label="TikTok">
              <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor">
            ...
            <a href="#" className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-900 transition-transform duration-200 hover:scale-[1.06]" aria-label="Facebook">
              <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor">
                <path d="M13.5 22v-8h2.7l.4-3h-3.1V9.1c0-.9.2-1.5 1.6-1.5h1.7V5c-.3 0-1.4-.1-2.8-.1-2.8 0-4.7 1.7-4.7 4.9V11H6.9v3h2.4v8h4.2Z" />
              </svg>
            </a>

            <a href="#" className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-white text-slate-900 transition-transform duration-200 hover:scale-[1.06]" aria-label="Instagram">
              <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor">
